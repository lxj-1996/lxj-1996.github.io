...
a='<span class="vsys">'+((t.get("mail")===e.config.user&&t.get("link")===e.config.pwd)?"作者":"")+'</span><span class="vsys">'+i.browser+" "+i.version+'</span> <span class="vsys">'+i.os+" "+i.osVersion+"</span>"),"*"===e.config.path&&(a='<a href="'+t.get("url")+'" class="vsys">'+t.get("url")+"</a>");
// console.log(t.get("mail").toLowerCase())
//qq 头像接口
//var qq_img = m.cdn + a(e.get("mail")) + m.params;//v1.3.10
var qq_img = ($.cdn+(0,s.default)(t.get("mail"))+$.params);
if (t.get("mail").toLowerCase().indexOf("@qq.com") >= 0) {
...
var l=(t.get("link")===e.config.pwd?window.location.href:t.get("link")?/^https?\:\/\//.test(t.get("link"))?t.get("link"):"http://"+t.get("link"):""),

c=l?'<a class="vnick" rel="nofollow" href="'+l+'" target="_blank" >'+t.get("nick")+"</a>":'<span class="vnick">'+t.get("nick")+"</span>",

u=$.hide?"":'<img class="vimg" src="'+(qq_img)+'">',

d=u+'<div class="vh"><div class="vhead">'+c+" "+a+'</div><div class="vmeta"><span class="vtime" >'+(0,v.default)(t.get("insertedAt"),e.i18n)+'</span><span class="vat" data-root-id="'+(t.get("rid")||t.id)+'" data-self-id="'+t.id+'">'+e.i18n.t("reply")+'</span></div><div class="vcontent" data-expand="'+e.i18n.t("expand")+'">'+(0,y.default)(t.get("comment"))+'</div><div class="vreply-wrapper" data-self-id="'+t.id+'"></div><div class="vquote" data-self-id="'+t.id+'"></div></div>';
